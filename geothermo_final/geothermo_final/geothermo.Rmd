---
title: "Bayetal20a_Geothermo_Final"
author: "Harp Batther and Tristan Caro"
...
output:
  ...
  pdf_document:
    toc: yes
    toc_depth: '2'
class: Geothermodynamics Spring21
editor_options:
...
$$
H_2 + 0.5~O_2 \rightarrow H_2O \\

Q = \frac{[H_20]}{[H_2][O_2]^{(1/2)}} \\
\space \\
...
CH_4 + 2~O_2 \rightarrow CO_2 + 2H_2O \\
...
```{r}
p_gas_data <- gas_data %>% ggplot(aes(x = Gas, y = P, fill = Gas)) +
